...
Defines one-time household bootstrap, household user administration, credential rotation, session visibility and revocation, and operator-assisted total-lockout recovery.
