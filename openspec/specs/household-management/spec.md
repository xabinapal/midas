...
Defines generic household membership, member and user separation, default allocation weights, member lifecycle with historical preservation, and household currency and locale.
