...
Defines durable append-only household activity events with allow-listed safe summaries, sensitive-data exclusion, household-scoped history access, the per-household operation gate, and actor preservation.
