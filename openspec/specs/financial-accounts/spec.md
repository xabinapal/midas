...
Defines household financial accounts with explicit personal/shared classification and effective-dated holders, the draft/active/closed lifecycle, exact posted account transfers with one economic classification, dated manual balance observations, estimated available balances anchored to those observations, correction by reversal and replacement, and deterministic account history.
